...
public class C03_DropDownMenu03 extends TestBase_Each {
    ...
    //10. “US Dollars” in secilmedigini test edin
        ...
        Assertions.assertFalse(Usd.isSelected());
    ...
    //13. “Foreign currency cash was successfully purchased.” yazisinin ciktigini kontrol edin.
        ...
        String expectedResultText = "Foreign currency cash was successfully purchased.";
        String actualResultText = driver.findElement(By.id("alert_content")).getText();
